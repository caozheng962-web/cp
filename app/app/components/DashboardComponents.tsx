...
export function DashboardTabs({ evaluations }: { evaluations: Evaluation[] }) {
...
export function OverviewTab({ evaluations }: { evaluations: Evaluation[] }) {
...
export function SkuDetailsTab({ evaluations }: { evaluations: Evaluation[] }) {
...
export function ProblemDistributionTab({ evaluations }: { evaluations: Evaluation[] }) {
